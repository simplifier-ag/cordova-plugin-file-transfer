...
public class FileTransfer extends CordovaPlugin {
	...
	private static final HashMap<String, RequestContext> activeRequests = new HashMap<String, RequestContext>();
	...
	private static class TrackingGZIPInputStream extends TrackingInputStream {
		private final ExposedGZIPInputStream gzin;
		...
		cordova.getThreadPool().execute(new Runnable() {
			public void run() {
				...
				try {
					...
					byte[] beforeDataBytes = beforeData.toString().getBytes(StandardCharsets.UTF_8);
					...
					try (TrackingInputStream inStream = getInputStream(conn)) {
